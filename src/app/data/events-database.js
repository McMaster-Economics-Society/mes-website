const allEvents = [
  ...
  },
  {
    ...
    description:
      "Whether you're a mentor, a mentee, or just looking to meet great people, you're invited! Join us for a relaxed mixer with games, fun conversations, and good company.",
    location: "LRW 3001",
    date: "March 6, 2026",
    eventDate: "2026-03-06",
    time: "2:30PM - 4:00PM",
    image: "/event-images/mentorship-mixer-event.png",
    imageAlt: "Mentorship Mixer",
    link: "",
    buttonType: "rsvp",
    closed: false,
  },
  ...
  {
    id: 7,
    title: "Game Theory: An MES Game Night",
