    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.alertBanner}>
          <div className={styles.alertContent}>
            ...
            <div className={styles.alertText}>
              <p>
                Please check out the current job openings at MES! The Case Study
                Competition Team applications close on September 12th 2025 at
                11:59PM EST.
              </p>
        ...
        <main className={styles.main}>
          ...
          {/* Case Study Competition Team - Full Width Section */}
          <div className={styles.caseStudyFullWidth}>
            <div
              className={`${styles.opportunityCard} ${styles.caseStudyCompetition}`}
            >
                ...
                <div className={styles.cardTitleSection}>
                  <div className={styles.titleRow}>
                    <h3 className={styles.cardTitle}>
                      Case Study Competition Team
                    </h3>
                    <span className={styles.hiringLabel}>HIRING!</span>
                  </div>

                  <p className={styles.cardDescription}>
                    Join the 2025-2026 executive team for MES&apos;s flagship
                    Case Study Competition, where students develop critical
                    thinking and strategic analysis skills through real-world
                    business challenges. Gain hands-on experience in event
                    coordination, academic programming, and professional
                    collaboration.
                  </p>
                  ...
                  {/* <div className={styles.noteSection}>
                    ...
                    <ul className={styles.sectionList}>
                      <li className={styles.listItem}>
                        All team members are expected to attend regular weekly
                        meetings, with flexibility for class conflicts.
                      </li>
                      <li className={styles.listItem}>
                        Time commitments vary depending on the planning stage
                        and event timeline.
                      </li>
                    </ul>
                  </div>*/}
                ...
                <div className={styles.positionsContainer}>
                  <div className={styles.position}>
                    ...
                    <div className={styles.section}>
                      <h6 className={styles.sectionSubtitle}>Role Overview:</h6>
                      <p className={styles.positionDescription}>
                        Events Coordinators will be responsible for designing
                        and executing the participant experience during the
                        competition. This includes planning structured elements
                        such as opening activities, networking sessions, and
                        speaker engagement.
                      </p>
                    </div>
                    <div className={styles.section}>
                      ...
                      <ul className={styles.sectionList}>
                        <li className={styles.listItem}>
                          Plan and coordinate event day components, including
                          icebreakers, networking sessions, and speaker
                          appearances
                        </li>
                        <li className={styles.listItem}>
                          Collaborate with the MES Academic and Events teams to
                          ensure seamless delivery
                        </li>
                        <li className={styles.listItem}>
                          Support the recruitment and scheduling of guest
                          speakers and judges
                        </li>
                        <li className={styles.listItem}>
                          Assist with day-of logistics, participant support, and
                          room coordination
                        </li>
                        <li className={styles.listItem}>
                          Help foster an engaging and professional event
                          environment
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className={styles.position}>
                    ...
                    <div className={styles.section}>
                      <h6 className={styles.sectionSubtitle}>Role Overview:</h6>
                      <p className={styles.positionDescription}>
                        Logistics Coordinators will handle all operational and
                        technical needs for the competition, from registration
                        to equipment setup, ensuring everything runs smoothly on
                        event day.
                      </p>
                    </div>
                    <div className={styles.section}>
                      ...
                      <ul className={styles.sectionList}>
                        <li className={styles.listItem}>
                          Manage participant registration and prepare event
                          materials
                        </li>
                        <li className={styles.listItem}>
                          Assist with budgeting and sponsorship-related tasks
                        </li>
                        <li className={styles.listItem}>
                          Secure and organize presentation tools, printed cases,
                          prizes, and kits
                        </li>
                        <li className={styles.listItem}>
                          Conduct venue tech checks and operate equipment during
                          the event
                        </li>
                        <li className={styles.listItem}>
                          Troubleshoot technical or material issues quickly
                        </li>
                        <li className={styles.listItem}>
                          Coordinate with the Events team to maintain smooth
                          competition flow
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className={styles.position}>
                    ...
                    <div className={styles.section}>
                      <h6 className={styles.sectionSubtitle}>Role Overview:</h6>
                      <p className={styles.positionDescription}>
                        The Academic Lead oversees all content-related and
                        educational components of the competition. This includes
                        case development or sourcing, working with judges and
                        evaluators, and organizing preparatory sessions for
                        participants.
                      </p>
                    </div>
                    <div className={styles.section}>
                      ...
                      <ul className={styles.sectionList}>
                        <li className={styles.listItem}>
                          Source or develop a relevant, well-structured business
                          case for the competition
                        </li>
                        <li className={styles.listItem}>
                          Design the judging criteria and evaluation rubric in
                          consultation with the MES Academic team members
                        </li>
                        <li className={styles.listItem}>
                          Coordinate with industry professionals and faculty
                          members to serve as judges
                        </li>
                        <li className={styles.listItem}>
                          Lead the planning of training modules or mock pitch
                          sessions for participants
                        </li>
                        <li className={styles.listItem}>
                          Ensure the competition maintains academic integrity,
                    ...
                    <div className={styles.section}>
                      ...
                      <ul className={styles.sectionList}>
                        ...
                        <li className={styles.listItem}>
                          Experience with case-based competitions
                        </li>
                        <li className={styles.listItem}>
                          Interest in strategy or education
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className={styles.cardFooter}>
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSepRlpO13IGSte1tz4qSzGeoOv2_DSow6I3_ZC9OtK6fMNMIQ/viewform"
